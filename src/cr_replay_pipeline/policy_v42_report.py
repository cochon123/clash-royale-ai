...
.model-card{{--tone:var(--blue);border-top:3px solid var(--tone)}}.model-card.v41{{--tone:var(--gold)}}.model-card.v42{{--tone:var(--green)}}
...
.big-number{{font-size:35px;font-weight:750;letter-spacing:-.05em;margin:17px 0 2px}}
.facts{{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:18px;padding-top:16px;border-top:1px solid var(--line)}}
.fact b,.fact span{{display:block}}.fact b{{font-size:14px}}.fact span{{font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.06em}}
.tta-reference{{display:flex;align-items:center;gap:10px;width:max-content;max-width:100%;margin:8px 0 4px;padding:9px 12px;border:1px solid #778143;border-radius:11px;background:rgba(232,245,139,.07);color:var(--star);font:700 12px "IBM Plex Mono",ui-monospace,monospace}}
...
.star-icon{{width:56px;height:56px;border-radius:16px;display:grid;place-items:center;background:var(--star);color:#152014;font-size:30px}}
...
.tta-line{{stroke:var(--star);stroke-width:1.5;stroke-dasharray:4 5;opacity:.8}}.tta-point{{fill:var(--star);stroke:#152014;stroke-width:3}}.tta-label{{fill:var(--star);font:700 12px "IBM Plex Mono",ui-monospace,monospace}}
.royale-grid{{display:grid;grid-template-columns:1fr 1.15fr;gap:14px}}
.podium{{display:grid;gap:11px;margin-top:18px}}
.rank{{display:grid;grid-template-columns:34px 1fr auto;align-items:center;gap:10px;padding:13px;border:1px solid var(--line);border-radius:13px}}
.rank:first-child{{border-color:#6b5830;background:#211d10}}
.rank-num{{font:800 18px "IBM Plex Mono",ui-monospace,monospace;color:var(--muted)}}
.rank b,.rank small{{display:block}}.rank small{{color:var(--muted)}}.score{{font:800 22px "IBM Plex Mono",ui-monospace,monospace}}
.h2h{{display:grid;gap:10px;margin-top:18px}}
.duel{{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:12px;padding:13px;border-radius:13px;background:#0a151c;border:1px solid var(--line)}}
.duel .left{{text-align:right}}.duel strong{{font:800 18px "IBM Plex Mono",ui-monospace,monospace}}.duel .vs{{color:#526a61;font:11px "IBM Plex Mono",ui-monospace,monospace}}
.arena-wrap{{display:grid;grid-template-columns:1fr 1fr;gap:18px;align-items:center}}
.arena-wrap .arena{{aspect-ratio:18/32;max-height:390px;margin:auto;border:2px solid #47675c;border-radius:16px;position:relative;background:linear-gradient(to bottom,#193b31 0 48%,#527b91 48% 52%,#193b31 52%);overflow:hidden;box-shadow:inset 0 0 60px #0007}}
.arena-wrap .arena:before{{content:"";position:absolute;inset:0;background:repeating-linear-gradient(90deg,transparent 0 5.45%,#ffffff08 5.45% 5.6%),repeating-linear-gradient(0deg,transparent 0 3.05%,#ffffff08 3.05% 3.2%)}}
.arena-wrap .arena .axis{{position:absolute;top:0;bottom:0;left:50%;width:2px;background:var(--green);box-shadow:0 0 18px var(--green)}}
.arena-wrap .arena .arrow{{position:absolute;left:16%;right:16%;top:34%;font:700 12px "IBM Plex Mono",ui-monospace,monospace;color:#d9f7eb;text-align:center}}
.arena-wrap .arena .arrow:last-child{{top:61%}}
.mirror-copy{{display:grid;gap:16px}}.mirror-copy .step{{padding-left:16px;border-left:2px solid var(--green)}}
.mirror-copy b{{display:block;margin-bottom:3px}}.mirror-copy p{{font-size:13px}}
.chart-card{{padding:22px}}
@media(max-width:850px){{.model-grid,.royale-grid,.arena-wrap,.star-stats{{grid-template-columns:1fr}}}}
@media(max-width:540px){{.star-point{{grid-template-columns:1fr}}}}
</style>
</head>
<body><main>
<header class="hero">
